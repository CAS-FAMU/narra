...
describe Narra::API::Modules::LibrariesV1Metadata do
  ...
  context 'not authorized' do
    describe 'GET /v1/libraries/[:id]/metadata' do
      it 'returns all meta' do
        get '/v1/libraries/' + @library._id + '/metadata' + '?token=' + @unroled_token
    ...
    describe 'GET /v1/libraries/[:id]/metadata/[:name]' do
      it 'returns a specific meta' do
        get '/v1/libraries/' + @library._id + '/metadata/' + @meta_01.name + '?token=' + @unroled_token
    ...
    describe 'POST /v1/libraries/[:id]/metadata/update' do
      it 'updates specific meta' do
        post '/v1/libraries/' + @library._id + '/metadata/' + @meta_01.name + '/update' + '?token=' + @unroled_token, {value: 'updated'}
  ...
  context 'authenticated & authorized' do
    describe 'GET /v1/libraries/[:id]/metadata' do
      it 'returns all meta' do
        get '/v1/libraries/' + @library._id + '/metadata' + '?token=' + @author_token
    ...
    describe 'GET /v1/libraries/[:id]/metadata/[:name]' do
      it 'returns a specific meta' do
        get '/v1/libraries/' + @library._id + '/metadata/' + @meta_01.name + '?token=' + @author_token
    ...
    describe 'POST /v1/libraries/[:id]/metadata/update' do
      it 'updates specific meta' do
        post '/v1/libraries/' + @library._id + '/metadata/' + @meta_01.name + '/update' + '?token=' + @author_token, {value: 'updated'}
