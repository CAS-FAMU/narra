...
describe Narra::API::Modules::ProjectsV1Metadata do
  ...
  context 'not authenticated' do
    ...
    describe 'POST /v1/projects/[:name]/metadata/new' do
      it 'creates new meta' do
        post "/v1/projects/#{@project.name}/metadata/new", params: {meta: 'test', value: 'test'}
    ...
    describe 'POST /v1/projects/[:name]/metadata/update' do
      it 'updates specific meta' do
        post "/v1/projects/#{@project.name}/metadata/#{@meta_01.name}/update", params: {value: 'updated'}
  ...
  context 'not authorized' do
    describe 'GET /v1/projects/[:name]/metadata' do
      it 'returns all meta' do
        get "/v1/projects/#{@project.name}/metadata", params: {token: @unroled_token}
    ...
    describe 'GET /v1/projects/[:name]/metadata/[:name]' do
      it 'returns a specific meta' do
        get "/v1/projects/#{@project.name}/metadata/#{@meta_01.name}", params: {token: @unroled_token}
    ...
    describe 'POST /v1/projects/[:name]/metadata/new' do
      it 'creates new meta' do
        post "/v1/projects/#{@project.name}/metadata/new", params: {token: @unroled_token, meta: 'test', value: 'test'}
    ...
    describe 'POST /v1/projects/[:name]/metadata/[:meta]/update' do
      it 'updates specific meta' do
        post "/v1/projects/#{@project.name}/metadata/#{@meta_01.name}/update", params: {token: @unroled_token, value: 'updated'}
  ...
  context 'authenticated & authorized' do
    describe 'GET /v1/projects/[:name]/metadata' do
      it 'returns all meta' do
        get "/v1/projects/#{@project.name}/metadata", params: {token: @author_token}
    ...
    describe 'GET /v1/projects/[:name]/metadata/[:meta]' do
      it 'returns a specific meta' do
        get "/v1/projects/#{@project.name}/metadata/#{@meta_01.name}", params: {token: @author_token}
    ...
    describe 'POST /v1/projects/[:name]/metadata/new' do
      it 'creates new meta' do
        post "/v1/projects/#{@project.name}/metadata/new", params: {token: @author_token, meta: 'test', value: 'test'}
    ...
    describe 'POST /v1/projects/[:name]/metadata/update' do
      it 'updates specific meta' do
        post "/v1/projects/#{@project.name}/metadata/#{@meta_01.name}/update", params: {token: @author_token, value: 'updated'}
